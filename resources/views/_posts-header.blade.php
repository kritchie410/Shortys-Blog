    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }">
                ...
                <div x-show="show">
                    <a href="#" class="block text-left px-3 text-xs leading-5">One</a>
                    <a href="#" class="block text-left px-3 text-xs leading-5">Two</a>
                    <a href="#" class="block text-left px-3 text-xs leading-5">Three</a>
                </div>
            </div>
